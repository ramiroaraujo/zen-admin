...
$config = array(
  'SettingsData' => array(
    ...
    array(
      'id'          => 40,
      'name'        => 'Disable Cache',
      'description' => 'Deshabilita el Cache de la aplicación, forzando al browser a pedir todos los archivos al servidor',
      'type'        => 'boolean',
      'key'         => 'Cache.disable',
      'value'       => Configure::read( 'Cache.disable' ),
      'overridable' => TRUE,
      'overwritten' => FALSE,
      'warn'        => "Disable Cache está sobreescrito en tu sesión. La experiencia de usuario promedio puede ser diferente a la actual. Valor real: '%s', actual: '%s'"
    ),
    array(
      'id'          => 50,
...
if ( isset( $_COOKIE[ 'override_zenadmin' ][ '02802477545732966174938267102' ] ) )
{
  ...
  foreach ( $_COOKIE[ 'override_zenadmin' ][ '02802477545732966174938267102' ] as $id => $value )
  {
