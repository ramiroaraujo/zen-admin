...
/**
   * Holds validation messages map
   *
   * @var array
   */
  protected $_validationMessages = array(
    'alphanumeric'  => 'Completá el campo',
    'maxlength'     => 'Máximo %s caracteres',
    'between'       => 'Entre %s y %s caracteres',
    'mimetype'      => 'Tipo de archivo incorrecto',
    'blank'         => 'El campo debe estar vacío',
    'minlength'     => 'Máximo %s caracteres',
    'boolean'       => 'Valor incorrecto',
    'money'         => 'Ingresá un valor monetario',
    'cc'            => 'Ingresá un número de tarjeta de crédito',
    'multiple'      => 'Seleccioná entre %s y %s opciones',
    'comparison'    => 'Valor incorrecto',
    'naturalnumber' => 'Ingresá un número entero',
    'custom'        => 'Valor incorrecto',
    'notempty'      => 'Completá el campo',
    'date'          => 'Ingresá una fecha',
    'numeric'       => 'Ingresá un número',
    'datetime'      => 'Ingresá una fecha y hora',
    'phone'         => 'Ingresá un número de teléfono',
    'decimal'       => 'Ingresá un número con decimales',
    'postal'        => 'Ingresá el código postal',
    'email'         => 'Ingresá un email',
    'range'         => 'Ingresá un número entre %s y %s',
    'equalto'       => 'El valor debe ser igual a %s',
    'ssn'           => 'Valor incorrecto',
    'extension'     => 'Tipo de archivo incorrecto',
    'time'          => 'Ingresá un horario',
    'filesize'      => 'El archivo no debe pesar más de %s MB',
    'uploaderror'   => 'El archivo no se subió correctamente',
    'inlist'        => 'Ingresá un valor de la lista',
    'url'           => 'Ingresá una URL',
    'ip'            => 'Ingresá una dirección de IP',
    'userdefined'   => 'Valor incorrecto',
    'luhn'          => 'Valor incorrecto',
    'uuid'          => 'Valor incorrecto',
    'isUnique'      => 'El valor debe ser único entre todos los registros cargados',
    'isForeignKey'  => 'El registro asociado no existe',
  );
 ...
 */
	protected function _interactive() {
      ...
      $prompt = __d( 'cake_console', "Would you like to map/translate field names and model/controller names?" );
      $wannaDoFieldNames = $this->in( $prompt, array( 'y', 'n' ), 'y' );
      if ( strtolower( $wannaDoFieldNames ) === 'y' )
      {
        $singularName = $this->in( __d( 'cake_console', 'Singular name for collection?' ), NULL, $currentModelName );
        $pluralName = $this->in( __d( 'cake_console', 'Plural name for collection?' ), NULL, Inflector::pluralize( $currentModelName ) );
        $fieldNames = array();
        foreach ( $fields as $name => $field )
        {
          $hint = isset( $this->fieldMaps[ $name ] ) ? $this->fieldMaps[ $name ] : $name;
          $newname = $this->in( __d( 'cake_console', "Name for field '{$name}'" ), NULL, $hint );
          $this->fieldMaps[ $name ] = $newname;
          $fieldNames[ $name ] = $newname;
        }
      }
      else
      {
        $singularName = $currentModelName;
        $pluralName = Inflector::pluralize( $currentModelName );
        foreach ( $fields as $name => $field ) $fieldNames[ $name ] = $name;
      }
      ...
      $vars = compact( 'associations', 'fieldNames', 'validate', 'primaryKey', 'useTable', 'displayField', 'messages', 'fields', 'singularName', 'pluralName' );
 ...
 */
	public function initValidations() {
        ...
        $choices[ $default++ ] = 'isUnique';
        $choices[ $default++ ] = 'isForeignKey';
