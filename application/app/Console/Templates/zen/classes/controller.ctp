...
echo "\t/**\n\t * Components\n\t *\n\t * @var array\n\t */\n";
echo "\tpublic \$components = array( 'Search.Prg' => array('commonProcess' => array('paramType' => 'named'), 'presetForm' => array('paramType' => 'named')), ";
...
?>
    ...
    $this->set( 'model', $this-><?php echo $currentModelName ?> );
